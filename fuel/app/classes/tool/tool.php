...
class Tool_Tool {
    ...
    */
    ...
    public function weekdaySet($calendar_first_day){
    ...
    */
    public function calYearMonth($calendar_number, $this_year, $this_month){
        //当月が真ん中に来るように、$calendar_number分の年月情報$calendar_y_mを取得
        //カレンダーの数から、何ヶ月分前から取得する必要があるのかを計算
        $count = $this->calendarCount($calendar_number);
    ...
    *@return array 週の情報、
    */
    public function calendar($year, $month, $holidays, $calendar_first_day){
        //今月の最後の日
    ...
    */
    public function holidays($year, $month, $calendar_number){
    ...
    */
    public function schedulesGet($year, $month, $calendar_number){
    ...
    *@return int 
    */
    public function calendarCount($calendar_number){
        $count = -floor($calendar_number/2);
        return $count;
    }
    ...
    *@return int
    */
    public function calendarNumber(){
    ...
    */
    ...
    public function explode_string($str) {
        $explode_space = explode(' ', $str);
        return explode('-', $explode_space[0]); 
    }

    public function sprintf_str($str) {
        $result = sprintf('%01d', $str);
        return $result;
    }
